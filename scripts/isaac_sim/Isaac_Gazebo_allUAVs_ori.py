...
# pathtoworld = "omniverse://nucleusserver.andrew.cmu.edu/Projects/Champ/Map/Coastline_Map/Map_Robot.usd"
pathtoworld = "file:///home/clp/map_model_res/CHAMPORI/Map_Robot.usd"
...
def listener():
    ...
    rospy.Subscriber("/uav1/movecam", Quaternion, callback_cam1, queue_size = 10)
    rospy.Subscriber("/uav2/movecam", Quaternion, callback_cam2, queue_size = 10)
...
vdrone_prim = Robot("/World/UAVs/uav3","hexa")
...
vcamera1front_prim = Robot("/uav1_cam1","vcam1front")
vcamera2front_prim = Robot("/uav2_cam1","vcam2front")
listener()
