function [mu, s2, hyp2, rms, post] = gpml_rms(ind_train,Xs,Fs,Xtest_new,Ftest_new, hyp2_given)
...
hyp2 = struct('mean', [], 'cov', [0 0 0], 'lik', -1);
...
post = feval(covfunc, hyp2.cov, Xtest_new, Xtest_new);
if nargin > 4
